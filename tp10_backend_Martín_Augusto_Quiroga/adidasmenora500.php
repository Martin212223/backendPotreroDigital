...
<body>
    ...
    <button type="submit"><a href="adidas.php">Todos los precios de Adidas</a></button>
    <br>
    <h2>Lista de ropa</h2>
    ...
    <section>
        ...
        <?php
            ...
            $consulta= "SELECT * FROM `ropa` WHERE `marca` = 'addidas' AND `precio` < 500";
