...
<body>
    ...
    // 4) Mostrar los datos del registro
     while ($reg=mysqli_fetch_array($datos)) { ?>
        ...
        <td><img src="data:image/png;base64, <?php echo base64_encode($reg['imagen'])?>" alt="" style="width: 300px; height: auto"></td>
        <td><a href="#">Editar</a></td> <!-- modificar.php?id=<?php echo $reg['id'];?> -->
